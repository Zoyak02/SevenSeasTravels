        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary"> EDIT User Profile </h5>
                </div>
                <div class="card-body">
                <?php
                            ...
                            foreach($result as $row)
                              {
                                ?>
                                  ...
                                  <form action="usersEditProcess.php" method="POST">
    
                                  <input type="hidden" name="user_type" value="user">
                                  
                                  <div class="form-group">
                                      <label>User ID</label>
                                      <input type="text" name="edit_id" value="<?php echo $row['userID'] ?>"class="form-control" readonly>
                                    </div>
                                    <div class="form-group">
