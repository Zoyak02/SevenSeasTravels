...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.3.1/dist/admin_cssbootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
                            ...
                            foreach($result as $row)
                              {
                                ?>
                                  ...
                                  <form action="adminEditProcess.php" method="POST">

                                  <input type="hidden" name="user_type" value="admin">

                                  <div class="form-group">
                                      <label>Admin ID</label>
                                      <input type="text" name="edit_id" value="<?php echo $row['adminID'] ?>"class="form-control" readonly>
                                    </div>
                                    <div class="form-group">
