        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary"> EDIT Seven Seas Policies & Description </h5>
                </div>
                <div class="card-body">
                <?php
                            ...
                            foreach($result as $row)
                              {
                                ?>
                                  ...
                                  <form action="settingsEditProcess.php" method="POST">

                                    <input type="hidden" name="edit_policyID" value="<?php echo $row['policyID'] ?>">

                                    <div class="form-group">
                                      <label>Privacy Policy</label>
                                      <textarea name="edit_policyDescription" rows="6" class="form-control" placeholder="Enter Policy Description"><?php echo $row['policyDescription'] ?></textarea>
                                    </div>

                                    <div class="form-group">
                                      <label>About Us</label>
                                      <textarea name="edit_aboutUsDescription" rows="6" class="form-control" placeholder="Enter About Us Description"><?php echo $row['aboutUsDescription'] ?></textarea>
                                    </div>
