...
<!--==================== HOME ====================-->
        <main class="main">
           ...
           <div class="container">
            <div class="row">
                <div class="col-7">
                    <div class="p-2"> <img src="https://images.unsplash.com/photo-1550955530-9014e51c4447?auto=format&fit=crop&q=60&w=700&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NjJ8fGV1cm9wZXxlbnwwfHwwfHx8MA%3D%3D"></div>
                </div>
                <div class="col-5">
           ...
           <section class="package" id="package">
            <div class="container">
              ...
              <?php
                            $query = "SELECT * FROM `products` WHERE `tour_type` = 'europe'";
