<div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary"> EDIT Users </h5>
                </div>
                <div class="card-body">
      ...
      <table class="table table-bordered" id="dataTable" cellspacing="0">
        ...
        if(mysqli_num_rows($result) > 0)        
        {
          ...
          <tr>
            ...
            <td>
                <form action="usersEdit.php" method="post" style="text-align: center;">
                    <input type="hidden" name="edit_id" value="<?php echo $row["userID"]; ?>">
                    <button  type="submit" name="edit_btn" class="btn btn-success"> EDIT</button>
                </form>
            </td>
            <td>
                <form action="usersDelete.php" method="post" style="text-align: center;">
